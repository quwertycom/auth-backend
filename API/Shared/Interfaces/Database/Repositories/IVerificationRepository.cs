...
public interface IVerificationRepository
{
    ...
    public Task<EmailVerificationRequest?> GetEmailVerificationRequestByCodeAsync(string code);
    ...
    /// <returns>A task that represents the asynchronous operation. Returns the email verification request if found, otherwise null.</returns>
    public Task<EmailVerificationRequest?> GetEmailVerificationRequestByEmailIdAsync(long emailId);
    ...
    /// <returns>A task that represents the asynchronous operation. Returns the email verification request if found, otherwise null.</returns>
    public Task<EmailVerificationRequest?> GetEmailVerificationRequestByEmailStringAsync(string email);
    ...
    public Task<PasswordResetRequest?> GetPasswordResetRequestByCodeHashAsync(string codeHash);
    ...
    /// <returns>A task that represents the asynchronous operation. Returns the password reset request if found, otherwise null.</returns>
    public Task<PasswordResetRequest?> GetPasswordResetRequestByEmailIdAsync(long emailId);
    ...
    /// <returns>A task that represents the asynchronous operation. Returns the password reset request if found, otherwise null.</returns>
    public Task<PasswordResetRequest?> GetPasswordResetRequestByEmailStringAsync(string email);
    ...
    public Task<IEnumerable<PasswordResetRequest>> GetAllUserPasswordResetRequestsAsync(long userId);
    ...
    public Task<IEnumerable<PasswordResetRequest>> GetUserActivePasswordResetRequestsAsync(long userId);
